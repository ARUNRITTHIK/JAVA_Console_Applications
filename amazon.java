...
public class amazon {
    ...
    public static void list_of_merchants(){
        System.out.println("The List of Merchants : ");
        for(int i=0;i<mer_per_name.size();i++){
            System.out.println();
            System.out.println("Merchant number : "+(i+1)+"\n");
            System.out.println("Merchant Name :"+mer_per_name.get(i));
            System.out.println("Merchant ID   :"+mer_per_id.get(i));
        }
    }
    ...
    public static void list_all_products(){
        ...
        for(int i=0;i<pro_id.size();i++){
            System.out.println("Merchant Id      : "+pro_mer_id.get(i));
            System.out.println("Producr Id       : "+pro_id.get(i));
            System.out.println("Product category : "+pro_cat.get(i));
            System.out.println("Product name     : "+pro_cat_name.get(i));
            System.out.println("Product quantity : "+pro_quantity.get(i));
            System.out.println("Product price    : "+pro_price.get(i));
            System.out.println("Produt saled     : "+pro_saled.get(i));
    ...
    public static void list_product(int i){
        ...
        for(int j=0;j<pro_id.size();j++){
            if(list.equals(pro_mer_id.get(j))){
                System.out.println("The Merchant name is : "+pro_mer_id.get(j));
                System.out.println("The product id is : "+pro_id.get(j));
                System.out.println("The product category is : "+pro_cat_name.get(j));
                System.out.println("The product name is : "+pro_name.get(j));
                System.out.println("The product price is : "+pro_price.get(j));
                System.out.println("The product quantity is : "+pro_quantity.get(j));
                System.out.println("The product discount is : "+pro_discount.get(j));
                System.out.println("The most saled product is : "+pro_saled.get(j));
                System.out.println("................................................");
                System.out.println();
            }
        }
